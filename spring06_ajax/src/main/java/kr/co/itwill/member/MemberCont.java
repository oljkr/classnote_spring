...
public class MemberCont {
	...
	//결과확인 http://localhost:9095/member/idcheckcoockieform.do
	@RequestMapping("idcheckcoockieform.do")
	public String idCheckCookieForm() {
		return "/member/idCheck_cookie";
	}//idCheckCookieForm() end
	
	@RequestMapping("idcheckcoockieproc.do")
	@ResponseBody
	public String idCheckCoockieProc(HttpServletRequest req) {
		String userid=req.getParameter("userid").trim();
		String cnt="0";
		if(userid.equals("itwill") || userid.equals("webmaster")) {
			cnt="1";//아이디가 중복되었음
